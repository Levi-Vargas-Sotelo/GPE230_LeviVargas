...
#include "GPE230_LeviVargas/Public/NPCEnemy.h"
...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ANPCEnemy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ANPCEnemy_DetectHit, "DetectHit" }, // 3303150482
	};
	...
	template<> GPE230_LEVIVARGAS_API UClass* StaticClass<ANPCEnemy>()
	{
		return ANPCEnemy::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ANPCEnemy);
	ANPCEnemy::~ANPCEnemy() {}
	struct Z_CompiledInDeferFile_FID_GPE230_LeviVargas_Source_GPE230_LeviVargas_Public_NPCEnemy_h_Statics
	{
